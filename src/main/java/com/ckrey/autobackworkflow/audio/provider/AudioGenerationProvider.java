...
public interface AudioGenerationProvider {
    ...
    record ProviderCapabilities(boolean supportsEmotion, boolean supportsReferenceAudio, boolean supportsAsyncTask,
                                boolean supportsStreaming, java.util.Set<String> formats) {
    }

    record AudioGenerationCommand(String requestId, String modelCode, String text, String voiceId,
                                  VoiceDirection direction, String format, Map<String, Object> extensions) {
    }
